...
<div id="hotshowing">
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">上周末票房:<span class="officeNumber">1140.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">上周末票房:<span class="officeNumber">893.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<li id="showitAmericaOffice">
			 ...
			 <div class="boxOffice">
			 	<p class="lastWeekOffice">上周末票房:<span class="officeNumber">787.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">上周末票房:<span class="officeNumber">660.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">上周末票房:<span class="officeNumber">610.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">上周末票房:<span class="officeNumber">522.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">上周末票房:<span class="officeNumber">487.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">上周末票房:<span class="officeNumber">457.0</span>万</p>
