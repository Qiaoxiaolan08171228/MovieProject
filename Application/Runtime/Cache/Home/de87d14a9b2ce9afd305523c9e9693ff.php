...
<div id="hotshowing">
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
			   	<p class="lastWeekOffice">实时票房:<span class="officeNumber">3504.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">实时票房:<span class="officeNumber">1140.0</span>万</p>
				<p class="totalOffice">总票房:1.54亿</p>
			</div>
		</ul>
	</div>
	<!--num3-->
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
			   	<p class="lastWeekOffice">实时票房:<span class="officeNumber">893.0</span>万</p>
			   	<p class="totalOffice">总票房:893.0万</p>
			</div>
		</ul>
	</div>
	<!--  num4 -->
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">实时票房:<span class="officeNumber">787.0</span>万</p>
				<p class="totalOffice">总票房:3430.0万</p>
			</div>
		</ul>
	</div>
	<!-- num5 -->
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
			   	<p class="lastWeekOffice">实时票房:<span class="officeNumber">660.0</span>万</p>
			   	<p class="totalOffice">总票房:6359.0万</p>
			</div>
		</ul>
	</div>
	<!-- num6 -->
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">实时票房:<span class="officeNumber">652.0</span>万</p>
	...
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
			   	<p class="lastWeekOffice">实时票房:<span class="officeNumber">610.0</span>万</p>
			   	<p class="totalOffice">总票房:3.06亿</p>
			</div>
		</ul>
	</div> 
	<!--  num8 -->
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
				<p class="lastWeekOffice">实时票房:<span class="officeNumber">522.0</span>万</p>
				<p class="totalOffice">总票房:1939万</p>
			</div>
		</ul>
	</div> 
	<!--  num9 -->
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
			   	<p class="lastWeekOffice">实时票房:<span class="officeNumber">487.0</span>万</p>
			   	<p class="totalOffice">总票房:487.0万</p>
			</div>
		</ul>
	</div>
	<!--   num10 -->
	<div id="hslist1">
		<ul id="hslist1ul">
			...
			<div class="boxOffice">
			   	<p class="lastWeekOffice">实时票房:<span class="officeNumber">457.0</span>万</p>
			   	<p class="totalOffice">总票房:4282.0万</p>
			</div>
		</ul>
	</div>
</div>
